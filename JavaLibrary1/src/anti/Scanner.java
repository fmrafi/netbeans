...
jf=new JFrame("Virus Blocker 3.0.1.1");
jf.setLayout(null);
...
jl4=new JLabel("Software: Virus Blocker 3.0.1.1");
...
ImageIcon gh=new ImageIcon("Image/lvback.gif");
		   ...
		   panelImage=Toolkit.getDefaultToolkit().getImage("Image/Smart-Scanning.jpg");
...
jfc.add(rr);
		...
		rr.setText(rr.getText()+"\n\rSoftware Name:Virus Blocker 3.0.0.1 \n");
		//try{Thread.sleep(2000);}catch(Exception hy){}
		rr.setText(rr.getText()+"Version Info: 3.0.0.1 \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Author: Pravin H. Rane \n");
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Tester: Pravin H. Rane \n");
		//Thread.sleep(2000);
		...
		//Thread.sleep(2000);
		rr.setText(rr.getText()+"Relising Date: 1 may 2011 \n");
		//Thread.sleep(2000);
...
public static void main(String args[])
{
	...
	System.out.println("				  Pravin H. Rane   \n");
...
JLabel l=new JLabel(new ImageIcon("Image/Smart-Scanning.jpg"));
...
File fg=new File("C:/Windows/Key.html");
if( fg.exists() )
{
al=1;
}
...
public void actionPerformed(ActionEvent e)
{
	...
	{
	FileWriter ff=new FileWriter("C:/Windows/key.html");
